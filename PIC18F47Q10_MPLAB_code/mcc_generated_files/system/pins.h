...
#define RC1_SetInterruptHandler  IO_RC1_SetInterruptHandler
...
/**
 * @ingroup  pinsdriver
 * @brief Interrupt on Change Handler for the IO_RC1 pin functionality
 * @param none
 * @return none
 */
...
/**
 * @ingroup  pinsdriver
 * @brief Interrupt Handler Setter for IO_RC1 pin interrupt-on-change functionality.
...
/**
 * @ingroup  pinsdriver
 * @brief Dynamic Interrupt Handler for IO_RC1 pin.
 *        This is a dynamic interrupt handler to be used together with the IO_RC1_SetInterruptHandler() method.
 *        This handler is called every time the IO_RC1 ISR is executed and allows any function to be registered at runtime.
 * @pre Pins intializer called
 * @param none
 * @return none
 */
...
/**
 * @ingroup  pinsdriver
 * @brief Default Interrupt Handler for IO_RC1 pin. 
 *        This is a predefined interrupt handler to be used together with the IO_RC1_SetInterruptHandler() method.
 *        This handler is called every time the IO_RC1 ISR is executed. 
 * @pre Pins intializer called
 * @param none
 * @return none
 */
